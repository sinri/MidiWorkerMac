...
//            NSLog(@"MN = %@",mn);
            ...
            if ([mn hasPrefix:@"1="]) {
                ...
                for (NSString*onechar in charArray) {
                    ...
                    if(state==0){
                        if([onechar isEqualToString:@"b"]){
                            code-=1;
                            NMN_name=[NMN_name stringByAppendingString:@"♭"];
                        }else if([onechar isEqualToString:@"#"]){
                            code+=1;
                            NMN_name=[NMN_name stringByAppendingString:@"♯"];
                        }else if([onechar isEqualToString:@"0"]){
                            code=0xFF;
                            NMN_name=[NMN_name stringByAppendingString:onechar];
                ...
                [thenote setNMN_dot:NMN_dot];
                [thenote setNMN_hyphen:NMN_hyphen];
                [thenote setNMN_name:NMN_name];
                [thenote setNMN_octave:NMN_octave];
                [thenote setNMN_underline:NMN_underline];
                if(isInCycle){
